...
vi.mock('../../src/gameobjects/Shard', () => ({
    Shard: class MockShard {
        ...
        getIsActive() { return this._active; }
...
describe('ShardManager', () => {
    ...
    describe('constructor', () => {
        ...
        it('should set up event listeners', () => {
            expect(mockScene.events.on).toHaveBeenCalledWith('shard-collected', expect.any(Function), expect.any(Object));
            expect(mockScene.events.on).toHaveBeenCalledWith('shard-expired', expect.any(Function), expect.any(Object));
        });
    });
    ...
    describe('event handling', () => {
        it('should handle shard collected event', () => {
            ...
            mockScene.events.on.mock.calls
                .find(call => call[0] === 'shard-collected')[1]({ shard, value: 10, position: { x: 100, y: 100 } });
        ...
        it('should handle shard expired event', () => {
            ...
            mockScene.events.on.mock.calls
                .find(call => call[0] === 'shard-expired')[1]({ shard, position: { x: 100, y: 100 } });
