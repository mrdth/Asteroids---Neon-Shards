export class ScreenWrap {
     ...
     */
    static wrap(object: Phaser.GameObjects.GameObject & { x: number; y: number; width: number; height: number }, bounds: Phaser.Geom.Rectangle): void {
     ...
     */
    static isOutsideBounds(object: Phaser.GameObjects.GameObject & { x: number; y: number; width: number; height: number }, bounds: Phaser.Geom.Rectangle): boolean {
        const halfWidth = object.width / 2;
        const halfHeight = object.height / 2;
